...
import {innerOffset, padding, viewBoxSize, xUnit} from "./config";
import {GraphPoint} from "../../types/common.types";
...
export const createPathForRoundedCorners = (leftBottomCorner: GraphPoint, topRightCorner: GraphPoint, radius: number) => {
