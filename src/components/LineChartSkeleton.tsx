...
const LineChartSkeleton = ({height}: LineChartSkeletonProps) => {
    ...
    return <Skeleton classNameContainer='flex-1' style={{
        ...
        <Svg preserveAspectRatio='none' viewBox='0 0 200 200' style={{ height: 300, backgroundColor: colors[colorScheme].element }}>
            ...
            <Path d='M 25,165 C 38,165 33,100 46,100 C 59,100 54,70 67,70 C 80,70 75,140, 88,140 C 101,140 96,30 109,30 C 122,30, 117,155 130,155 C 143,155 138,130 151,130 C 164,130 159,90 172,90 C 185,90 180,120 193,120 L 193,165 L 25,165' strokeWidth={0} opacity={0.6} stroke={colors[colorScheme].skeletonContent} fill={colors[colorScheme].skeletonContent}/>
        </Svg>
    </Skeleton>
}
